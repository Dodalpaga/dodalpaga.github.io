...
type Props = { onSubmit: (urls: string[]) => void; onClose?: () => void };

export function EmptyState({ onSubmit, onClose }: Props) {
    ...
    >
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
          ...
          {onClose && (
            <button type="button" aria-label="Close COG picker" onClick={onClose}>
              Close
            </button>
          )}
        </div>
